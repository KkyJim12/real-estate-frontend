<template>
  <!-- Navigation -->
  <nav class="h-auto lg:h-28 px-4 sm:px-8 lg:px-60 bg-[#1d1d39] py-4 lg:py-0">
    <div class="flex flex-col lg:flex-row items-center justify-between lg:relative gap-4 lg:gap-0">
      <!-- Left Section - Contact Info -->
      <div class="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 w-full lg:w-auto justify-center lg:justify-start">
  ...
  <!-- About Us Section -->
  <div class="py-10 sm:py-16 lg:py-20 flex flex-col items-center justify-center space-y-4 sm:space-y-6 px-4 sm:px-8 lg:px-96">
    <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#36384f] text-center">ABOUT US</h2>
    <p class="text-sm sm:text-base lg:text-xl text-[#2c3c51] text-center max-w-4xl">
      ...
      <span class="block mb-2">the luxurious resort condominium on the best location that offers walking-distance</span>
      <span class="block">convenience amidst serene comfort among unique greenery shade over 25 rai area.</span>
    </p>
  </div>
  ...
  <div class="flex flex-col space-y-12 sm:space-y-16 lg:space-y-20 px-4 sm:px-8 lg:px-96 pb-16 sm:pb-24 lg:pb-32">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 lg:gap-x-20">
      <div class="lg:col-span-7 order-2 lg:order-1">
        <div class="flex flex-col justify-center h-full space-y-4 sm:space-y-6 lg:space-y-8 w-full">
          <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#36384f]">RAMADA EMERALD BAY</h2>
          <hr class="border-t-2 sm:border-t-3 border-[#ecbc85] w-full sm:w-4/5" />
          <p class="text-sm sm:text-base lg:text-xl text-[#2c3c51]">
            <span class="block mb-2">The allure of silence on the prime spot.</span>
            <span class="block mb-2">The new treasure of investment on the kingdom of perfect ease</span>
            <span class="block">and privacy.</span>
          </p>
          <NuxtLink
            class="bg-[#36364e] w-full sm:w-48 lg:w-40 py-2 sm:py-3 flex justify-center text-white text-base sm:text-lg lg:text-xl duration-200 hover:bg-[#ecbc85]"
            to="/"
          >
            VIEW MORE
          </NuxtLink>
      ...
      <div class="lg:col-span-5 order-1 lg:order-2">
        <NuxtImg
          class="w-full h-64 sm:h-80 lg:h-full object-cover rounded-lg lg:rounded-none"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-10 lg:gap-x-20">
      ...
      <div class="lg:col-span-7 order-2">
        <div class="flex flex-col justify-center h-full space-y-4 sm:space-y-6 lg:space-y-8 w-full">
          <h2 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#36384f]">CONVILLA</h2>
          <hr class="border-t-2 sm:border-t-3 border-[#ecbc85] w-full sm:w-4/5" />
          <p class="text-sm sm:text-base lg:text-xl text-[#2c3c51]">
  ...
  <footer class="bg-[#1d1d39] px-4 sm:px-8 lg:px-96 py-12 sm:py-16 lg:py-20">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-6">
      <!-- Contact Us -->
    ...
    <div class="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10">
      <p class="text-white/60 text-xs sm:text-sm text-center">
        © {{ new Date().getFullYear() }} Emerald Bay Pattaya. All rights reserved.
      </p>
    </div>
  </footer>
</template>
