  ...
  <div class="space-y-4">
    ...
    <div class="relative">
      <component
        ...
        :class="[
          'w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ecbc85] focus:border-transparent outline-none transition',
      ...
      >
        <div
          :class="[
            ...
            localValue[lang.code]?.trim() ? 'bg-green-500' : 'bg-gray-300'
          ]"
        ></div>
        <span>{{ lang.name }}</span>
      </div>
